                        ...
                        <div class="row">
                            <div class=" col-md-11 vertical-row">
                                <ul class="nav nav-pills vertical-nav col-md-4 pull-right">
                                    ...
                                    <li class="{{ $index == 0 ? "active" : ''  }}"><span><button  class=" delete-btn btn  btn-danger delete-category" data-id="{{ route('categories.destroy',Hashids::encode($category->id))}}">حذف</button></span> <a href="#{{ Hashids::encode($category->id) }}" data-toggle="tab">{{ $category->name }}</a>
                                </li>
                                @endforeach
