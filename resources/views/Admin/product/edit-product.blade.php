        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="panel panel-default">
                    ...
                    <!-- /.panel-heading -->
                    <div class="panel-body">
                        <form id="edit-product-form" action="#" enctype="multipart/form-data" method="post"
                                ...
                                <div class="tab-pane fade active in" id="home">
                                    <div style="padding-top: 20px;" class="col-lg-12">
                                        <div>
                                            ...
                                            <input class="form-control " placeholder="نام محصول" name="name" type="text"
                                                value="{{ $product->name }}">
                                        </div>
                                        <div class="row">
                                            <div class="col-md-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input class="form-control " type="text" placeholder="موجودی"
                                                    name="available_num" value="{{ $product->available_num}}">
                                            </div>
                                            <div class="col-md-4">
                                                <label> محصول دارای رنگ بندی میباشد:</label>
                                                <label class="switch switch-3d switch-primary pull-right">
                                                    <input type="checkbox" class="switch-input" name="color" {{
                                                        $product->color==1? "checked=" : ""}}>
                                                    <span class="switch-label"></span>
                                                    <span class="switch-handle"></span>
                                                </label>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                ...
                                                <label class="switch switch-3d switch-primary pull-right">
                                                    <input type="checkbox" class="switch-input" name="suggest" {{
                                                        $product->suggest==1? "checked=" :""}}>
                                                    <span class="switch-label"></span>
                                                    <span class="switch-handle"></span>
                                                </label>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select name="sub" id="subcategory"
                                                        ...
                                                        <option value="{{ $subcategory->id }}" {{ $product->
                    ...
                    {{ $product->description}}
                                ...
                                <div class="tab-pane fade" id="items">
                                    <div style="padding-top: 20px;" class="col-lg-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                <input name="items[]" class="form-control " type="text"
                                                    value="{{ $feature->item }}" readonly>
                                            </div>
                                            <div class="col-md-5"><input name="values[]" class="form-control "
                                                    type="text" value="{{ $feature->value }}"></div>
                                            <div class="col-md-2"><a
                                                    href="{{ route('product.item.delete',['id'=>$feature->id]) }}"
                                                    class="btn btn-primary btn-block delete-edit-item">حذف</a></div>
                                        </div>
                                        @endforeach
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="options">
                                    <div style="padding-top: 20px;" class="col-lg-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3"><input name="optionValue[]" class="form-control"
                                                    type="text" value="{{$option->value}}" readonly></div>
                                            <div class="col-md-3"><input class="form-control" type="text"
                                                    name="optionPrice[]" value="{{$option->price}}" readonly></div>
                                            <div class="col-md-2"><a href="#"
                                                    class="btn btn-primary btn-block delete-option">حذف</a></div>
                                        </div>
                                        @endforeach
                                    </div>
                                </div>
            ...
            {{ $product->seo_keyword}}
                                        ...
                                        <div class="row">
                                            ...
                                            <input class="form-control " type="text" value="{{ $product->tagNames }}"
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                ...
                                                <select name="discount-type">
                                                    ...
                                                    @if($discount != null)
                                                    <option value="2" {{ $discount->type == 2 ? "selected=selected" :""
                                                        }}>تومات(نقدی)</option>
                                                    @else
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input class="form-control numbersOnly" type="text"
                                                    ...
                                                    value="{{ $discount != null ? $discount->tprice : ""}}">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-5">
                                                ...
                                                <input class="form-control date" id="start-date"
                                                    placeholder="1396/07/22" data-groupid="group1" name="discount-start"
                                                    value="{{ $discount != null ? verta($discount->started_at)->format('Y-n-j') :"" }}">
                                            </div>
                                            <div class="col-md-5">
                                                ...
                                                <input class="form-control date" id="finish-date"
                                                    ...
                                                    value="{{ $discount != null ? verta($discount->finished_at)->format('Y-n-j') :"" }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <button class="btn btn-primary btn-block" id="edit-product">ویرایش
