							...
							<td>
								<div class="btn-group">
									...
									<ul class="dropdown-menu pull-right" role="menu">
										<li>
											@can('remove-item')
											<a data-element="#page-wrapper" href="{{ route('delete.items',['id'=>Hashids::encode($item->id)]) }}">حذف</a>
											@endcan
									</li>
									<li class="divider"></li>
									<li>
										@can('edit-item')
										<a href="{{ route('edit.items',['id'=>Hashids::encode($item->id)]) }}" class="edit-items" data-toggle="modal" data-target="#myModal">ویرایش</a>
										@endcan
								</li>
							</ul>
						</div>
