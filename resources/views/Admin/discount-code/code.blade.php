...
<div class="row">
	<div class="col-md-12">
		...
		<form id="add" class="collapse out" action="{{ route('code.store') }}" enctype="multipart/form-data" method="post" accept-charset="utf-8">
			{{ csrf_field() }}
			...
			<div class="row">
				<div class="col-md-12 col-sm-12 ">
					<button  style=" margin-bottom: 10px;   width: 100%;" class="btn btn-info center discountcode">ثبت</button>
				</div>
			</div>
			<!-- </form> -->
		</form>
				...
				<table class="table table-striped table-hover" id="dataTables-example">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<div class="btn-group">
									<a class="btn btn-danger" href="{{ route('code.delete',['id'=>$code->id]) }}">حذف</a>
                              </div>
					</td>
				</tr>
				@endforeach
